# Generated by Django 4.2.18 on 2025-02-24 07:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('shop', '0006_alter_productimagemodel_options_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(max_length=50)),
                ('zip_code', models.CharField(max_length=50)),
                ('status', models.IntegerField(choices=[(1, 'در انتظار پرداخت'), (2, 'در حال پردازش'), (3, 'ارسال شده'), (4, 'تحویل داده شده'), (5, 'لغو شده')], default=1)),
